...
| S-003 | Qualität | Schnelle CI deckt keine echten Browser- oder IndexedDB-Läufe ab | browserabhängige Fehler können erst im Release-Gate auffallen | drei Browsergruppen getrennt vor Release ausführen | Kontrolliert |
...
| S-005 | Browserdaten | Nutzer kann Browserdaten manuell löschen | mehrere lokale Projekte könnten gemeinsam verloren gehen | Projekt-JSON-Export, Import und Sicherungserinnerung ergänzen | Offen |
...
| S-016 | Duplikate | eine Kopie übernimmt bewusst alle fachlichen Antworten | vertrauliche Inhalte können unbeabsichtigt kopiert werden | Kopie eindeutig benennen, neue ID anzeigen und später Export-/Datenschutzvorschau ergänzen | Beobachtung |
...
- Endgültiges Löschen ist auf das bestätigte Papierkorbprojekt begrenzt.
- Der Wechsel vom aktuellen Projekt wird mit serieller Speicherung und aktivem Ersatzprojekt abgesichert.
